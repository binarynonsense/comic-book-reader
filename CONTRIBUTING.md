...
If you want to update or have suggestions for already available localization files and/or documents, create an issue to talk about it and check if they have an active maintainer, to propose the changes to them, before creating a pull request.
